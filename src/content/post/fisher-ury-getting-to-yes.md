---
title: "Getting to Yes — Principled Negotiation (Fisher & Ury)"
description: "Why positional bargaining is a trap, how to change the game at the meta-level, and the practical mechanics of being soft on people and hard on the problem."
publishDate: "2025-12-14T12:00:00Z"
tags: ["getting-to-yes", "negotiation", "principled-negotiation", "fisher-ury", "communication", "books"]
hidden: false
---
...
1. **Substance (merit)** — money, scope, deadlines, terms.
2. **The game (process / meta-game)** — what rules we’re using: positional arm-wrestling or problem-solving.
...
This creates a paradox that often helps cooperation:
the more you insist on clarity and constraints, the more important it becomes to be calm and respectful, so it doesn’t turn into an ego fight.
...
2) **Searching for the single best answer**  
...
4) **Thinking their problem is their problem**  
...
4) **Make it easy for the other side to decide**  
...
1) **Start with the concrete problem**  
   Describe the current situation you are dissatisfied with.

2) **Move to descriptive analysis (diagnosis) using general categories**  
...
3) **Move to general approaches (theory-driven solution classes)**  
   Based on diagnosis, you search for broad solution patterns that *tend* to work for that kind of problem.

4) **Return to concrete, actionable proposals**  
